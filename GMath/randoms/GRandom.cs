...
namespace GMath
{
    public static partial class GRandom
    {
        ...
        public static float2 random2(float2 min, float2 max)
        {
            return random2() * (max - min) + min;
        }

        public static float3 random3()
        {
            return float3(random(), random(), random());
        }

        public static float3 random3(float3 min, float3 max)
        {
            return random3() * (max - min) + min;
        }

        public static float4 random4()
        {
            return float4(random(), random(), random(), random());
        }

        public static float4 random4(float4 min, float4 max)
        {
        ...
        /// </summary>
        public static float3 randomDirection(float3 D)
        {
            float r1 = random();
            float r2 = random() * 2 - 1;
            float sqrR2 = r2 * r2;
        ...
        /// </summary>
        public static float3 randomHSDirection(float3 N, out float NdotD)
        {
            float r1 = random();
            float r2 = random() * 2 - 1;
            float sqrR2 = r2 * r2;
        ...
        public static float3 gauss3()
        {
            return BM_4().xyz;
        }

        public static float2 gauss2()
        {
            return BM_2();
        }

        public static float4 gauss4()
        {
            return BM_4();
        }
        ...
        public static float2 gauss2(float2 mu, float2 sigma)
        {
            return gauss2() * sigma + mu;
        }

        public static float3 gauss3(float3 mu, float3 sigma)
        {
            return gauss3() * sigma + mu;
        }

        public static float4 gauss4(float4 mu, float4 sigma)
        {
